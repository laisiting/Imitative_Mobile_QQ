...
export default {
    ...
    methods: {
        ...
        // 打开我的个性名片
        openMyCard() {
            this.$router.push('/card?profile=my_profile.jpg&name=stars&qq=1164585349&gender=女&age=21&birth_month=10&birth_day=22&constellation=天秤&place=广东广州&sign=个性签名');
        }
    }
}
</script>
