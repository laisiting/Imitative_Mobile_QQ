    ...
    data() {
        return {
            ...
            myFriends: { //好友对象，存储所有好友的信息
                lafei: {
                    path: '/card',
                    query: { profile:'啊菲.jpg', name:'啊菲', qq:'1164585301', gender:'女', age:15, birth_month:10, birth_day:30, constellation:'天蝎', place:'日本东京', sign:'睡觉觉~' }
                },
                zerotwo: {
                    path: '/card',
                ...
                mirai: {
                    path: '/card',
                    query: { profile:'profile_栗山未来.jpg', name:'二条', qq:'1164585303', gender:'女', age:17, birth_month:3, birth_day:31, constellation:'白羊', place:'日本东京', sign:'不愉快~' }
                },
                zhezhi: {
                    path: '/card',
                    query: { profile:'profile_鸢一折纸.jpg', name:'一饼', qq:'1164585304', gender:'女', age:16, birth_month:11, birth_day:11, constellation:'天蝎', place:'日本东京', sign:'绝灭天使' }
                },
                erya: {
                    path: '/card',
                    query: { profile:'二六南.jpg', name:'二六南', qq:'1164585305', gender:'女', age:17, birth_month:2, birth_day:29, constellation:'双鱼', place:'日本东京', sign:'嗫告篇帙' }
                },
                kuangsan: {
                    path: '/card',
                    query: { profile:'中發白.jpg', name:'中發白', qq:'1164585306', gender:'女', age:17, birth_month:6, birth_day:10, constellation:'双子', place:'日本东京', sign:'刻刻帝' }
                },
                siminai: {
                    path: '/card',
                    query: { profile:'一五九.jpg', name:'一五九', qq:'1164585307', gender:'女', age:13, birth_month:3, birth_day:20, constellation:'双鱼', place:'日本东京', sign:'冰结傀儡' }
                },
                qinli: {
                    path: '/card',
                    query: { profile:'三七西.jpg', name:'三七西', qq:'1164585308', gender:'女', age:14, birth_month:8, birth_day:3, constellation:'狮子', place:'日本东京', sign:'灼烂歼鬼' }
                },
                liucan: {
                    path: '/card',
                    query: { profile:'四八北.jpg', name:'四八北', qq:'1164585309', gender:'女', age:14, birth_month:9, birth_day:12, constellation:'处女', place:'日本东京', sign:'封解主' }
                },
                qizui: {
                    path: '/card',
                    query: { profile:'幺九.jpg', name:'幺九', qq:'1164585310', gender:'女', age:13, birth_month:7, birth_day:23, constellation:'狮子', place:'日本东京', sign:'赝造魔女' }
                },
                xixuan: {
                    path: '/card',
                    query: { profile:'清逸四.jpg', name:'清逸四', qq:'1164585311', gender:'女', age:18, birth_month:10, birth_day:18, constellation:'天秤', place:'日本东京', sign:'飓风骑士' }
                },
                yejushi: {
                    path: '/card',
                    query: { profile:'profile_八舞耶俱矢.jpg', name:'扛包', qq:'1164585312', gender:'女', age:18, birth_month:10, birth_day:18, constellation:'天秤', place:'日本东京', sign:'飓风骑士' }
                },
                meijiu: {
                    path: '/card',
                    query: { profile:'profile_诱宵美九.jpg', name:'啊b', qq:'1164585313', gender:'女', age:18, birth_month:1, birth_day:19, constellation:'摩羯', place:'日本东京', sign:'破军歌姬' }
                },
                shixiang: {
                    path: '/card',
                    query: { profile:'profile_夜刀神十香.jpg', name:'偏彰期', qq:'1164585314', gender:'女', age:18, birth_month:4, birth_day:10, constellation:'白羊', place:'日本东京', sign:'鏖杀公' }
                }
            }
        };
    }
